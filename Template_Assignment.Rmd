...
```{r}
library(readr)
moeiterondkomennederland <- read_csv("data/moeiterondkomennederland.csv")
View(moeiterondkomennederland)

library(readr)
moeiterondkomennederland <- read_delim("data/moeiterondkomennederland.csv", 
    delim = ";")
View(moeiterondkomennederland)
```
...
=======
>>>>>>> 460033be50ef3abb6ee7a1de0d8cd7bffb252f89
